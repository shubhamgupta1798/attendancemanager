...
class StarbuzzDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final  String  TABLE_NAME66="EXAMDATE";
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL("create table " + TABLE_NAME66 +" (SUBJECT TEXT,DATE date not null)");
...
deletegender(db);
    ...
    public boolean examdate(SQLiteDatabase db,String sub,String date)
    {
        ...
        Cursor c=db.query(TABLE_NAME66,new String[]{"SUBJECT"},"SUBJECT = ?",new String[]{sub},null,null,null);
        if(c.getCount()>0)
        {
            c.close();
            return u_examdate(db,sub,date);
        }
        Long A=db.insert(TABLE_NAME66,null,contentValues);
        if(A==-1)
        {
            return false;
        }
    ...
    {
        Cursor c=db.query(TABLE_NAME66,new String[]{"SUBJECT","DATE"},null,null,null,null,null);
        return c;
    }
    public boolean u_examdate(SQLiteDatabase db,String sub,String  date)
    {
        ...
        contentValues.put("SUBJECT",sub);
        contentValues.put("DATE",date);
        long a=db.update(TABLE_NAME66,contentValues,"SUBJECT = ?",new String[]{sub});
        if(a==-1)
        {
            return false;
        }
